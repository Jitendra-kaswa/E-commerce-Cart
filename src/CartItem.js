        ...
        <div className="cart-item">
            ...
            <div className="right-block">
                ...
                <div className="cart-item-actions">
                    <img alt="increase" className="action-icons" onClick={()=>onIncreaseQuantity(product)} src="https://image.flaticon.com/icons/png/512/992/992651.png"/>
                    <img alt="decrease" className="action-icons" onClick={()=>onDecreaseQuantity(product)} src="https://image.flaticon.com/icons/png/512/992/992683.png"/>
                    <img alt="delete" className="action-icons" onClick={()=>onDeleteProduct(product)} src="https://image.flaticon.com/icons/png/512/3096/3096673.png"/>
                </div>
            </div>
        </div>
    )
